...
from marcjsonconverter.utils.textutils import wrap_text_in_a_box
...
class PluginContainer(object):
    ...
    def normalize_plugin_path(self, plugin_path):
        ...
        """
        invenio_path = os.path.abspath(os.path.join(CFG_PYLIBDIR, 'marcjsonconverter'))
                    ...
                    for reference_method_name, reference_method_code in \
                        ...
                        if reference_method_name in other_object_map:
                            check_signature(
                                ...
                                other_object_map[reference_method_name])
                        else:

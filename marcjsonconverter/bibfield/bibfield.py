...
from marcjsonconverter.bibfield.bibfield_reader import Reader
from marcjsonconverter.bibfield.bibfield_utils import SmartJson
...
CFG_BIBFIELD_READERS = PluginContainer(os.path.join(CFG_PYLIBDIR, 'bibfield',
                                                    'bibfield_*reader.py'),
...
def create_record(blob, master_format='marc', verbose=0, **additional_info):
    ...
    """
    from marcjsonconverter.bibfield.bibfield_marcreader import MarcReader
    reader = MarcReader(blob, **additional_info)
